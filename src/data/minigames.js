...
export const emailDeck = [
  ...
  // 💸 투자 시리즈
  { from: "삼성전자 IR", domain: "samsung-private-invest.com", subject: "삼성전자 비공개 투자자 모집", body: "삼성전자 비상장 지분 투자 기회입니다. 직장인 한정 선착순 50명. 최소 투자금 100만원.", attachment: "투자안내서.pdf", link: "samsung-private-invest.com/join", recipient: "개별 발송", time: "13:05", difficulty: "easy", type: "spam" },
