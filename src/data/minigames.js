...
export const emailDeck = [
  ...
  { from: "협력사 박대리", domain: "partner-office.kr", subject: "Re: 견적서 수정본 재송부드립니다", body: "지난 회의에서 요청하신 단가표 수정본 첨부드립니다.", attachment: "견적서_수정본.xlsx", link: "없음", recipient: "구매 담당자", time: "11:06", difficulty: "normal", type: "good" },
  { from: "김부장", domain: "company.com", subject: "급한 건입니다", body: "회의 중이라 전화가 어렵습니다. 자료 먼저 검토 부탁드립니다.", attachment: "회의자료.pptx", link: "없음", recipient: "기획팀", time: "11:42", difficulty: "hard", type: "good" },
