...
export const emailDeck = [
  ...
  // 🎁 당첨 시리즈
  { from: "별벅스 이벤트", domain: "greenmug-gift-win.com", subject: "축하드립니다! 별벅스 1년 이용권 당첨", body: "고객님께서 별벅스 1년 이용권에 당첨되셨습니다. 24시간 내 수령 신청하지 않으면 당첨이 취소됩니다.", attachment: "없음", link: "greenmug-gift-win.com/prize", recipient: "개별 발송", time: "09:03", difficulty: "easy", type: "spam" },
  { from: "과일코리아 이벤트", domain: "fruitphone-giveaway.net", subject: "손폰 18 프로 맥스 지급 대상자 선정", body: "손폰 18 프로 맥스 증정 이벤트 당첨자로 선정되었습니다. 배송비 결제 후 발송됩니다.", attachment: "없음", link: "fruitphone-giveaway.net/redeem", recipient: "개별 발송", time: "10:22", difficulty: "easy", type: "spam" },
  { from: "직장인협회", domain: "worker-thanks-event.com", subject: "대한민국 직장인 감사 이벤트 — 무선귀팟 프로 증정", body: "직장인 감사 이벤트 당첨! 무선귀팟 프로 증정. 본인 확인 후 수령지를 입력해주세요.", attachment: "없음", link: "worker-thanks-event.com/gift", recipient: "개별 발송", time: "11:48", difficulty: "easy", type: "spam" },
  // 💸 투자 시리즈
