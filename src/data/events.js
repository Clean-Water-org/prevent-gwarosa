...
export const phoneCallPool = [
  {
    ...
    accept: { delta: { workload: 10, gameMinute: 5 }, log: "거래처 수정 요청이 추가되었습니다." },
    reject: { delta: { stress: 8 }, log: "거래처 전화를 거절했습니다." },
    missed: { delta: { stress: 12 }, log: "거래처 전화를 놓쳤습니다." },
  },
  {
    type: "client",
    name: "거래처",
    ...
    accept: { delta: { workload: 7, gameMinute: 4 }, log: "거래처 납기 확인 통화를 마쳤습니다." },
    reject: { delta: { stress: 6 }, log: "거래처 전화를 거절했습니다." },
    missed: { delta: { stress: 10 }, log: "거래처 전화를 놓쳤습니다." },
  },
  {
    type: "other-dept",
    name: "인사팀",
    ...
    accept: { delta: { stress: -5, gameMinute: 3 }, log: "인사팀 교육 안내를 확인했습니다." },
    reject: { delta: { stress: 4 }, log: "인사팀 전화를 거절했습니다." },
    missed: { delta: { stress: 6 }, log: "인사팀 전화를 놓쳤습니다." },
  },
  {
    type: "other-dept",
    name: "경영지원팀",
    ...
    accept: { delta: { workload: 5, gameMinute: 4 }, log: "경영지원팀 요청을 처리했습니다." },
    reject: { delta: { stress: 4 }, log: "경영지원팀 전화를 거절했습니다." },
    missed: { delta: { stress: 5 }, log: "경영지원팀 전화를 놓쳤습니다." },
  },
  {
    type: "unknown",
    name: "모르는 번호",
    ...
    accept: {
      outcomes: [
        { weight: 0.4, delta: { workload: 5, gameMinute: 4 }, log: "알고 보니 거래처였습니다. 수정 요청이 추가되었습니다." },
  ...
  },
  {
    ...
    accept: {
      outcomes: [
        { weight: 0.4, delta: { workload: 5, gameMinute: 4 }, log: "알고 보니 거래처였습니다. 추가 요청이 들어왔습니다." },
        { weight: 0.4, delta: { gameMinute: 2 }, log: "광고 전화였습니다." },
